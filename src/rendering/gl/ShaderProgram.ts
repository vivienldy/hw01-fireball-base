...
class ShaderProgram {
  ...
  unifBumpiness: WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifBumpiness    = gl.getUniformLocation(this.prog, "u_Bumpiness");
  ...
  setBumpiness(bumpiness: number) {
    this.use();
    if (this.unifBumpiness !== -1) {
      gl.uniform1f(this.unifBumpiness, bumpiness);
    }
  }
